...
def main():
    ...
    p.add_argument("--n",type=int,default=10000); p.add_argument("--seed",type=int,default=42); p.add_argument("--cv",type=int,default=5)
    a = p.parse_args(); data = make_synthetic(n=a.n,seed=a.seed); print(f"{data['n_samples']:,} samples, default rate={data['positive_rate']:.2%}")
