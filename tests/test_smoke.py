...
import numpy as np; from src.data import make_synthetic; from src.model import train_all_models, cross_validate; from src.core import compute_metrics
def test_data(): d=make_synthetic(500); assert d["X"].shape[0]==500 and 0.05<d["positive_rate"]<0.5
